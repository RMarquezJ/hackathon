...
player1.add_unit(red_ninja).add_unit(black_ninja).add_unit(yellow_ninja).add_effect(hard_algorithm).add_effect(not_managed_promise).add_effect(pair_programming)

player2.add_unit(red_ninja).add_unit(black_ninja).add_unit(yellow_ninja).add_effect(hard_algorithm).add_effect(not_managed_promise).add_effect(pair_programming)
